...
class CreateMessage(object):
    ...
    @property
    def message(self):
        """Gets the message of this CreateMessage.  # noqa: E501


        :return: The message of this CreateMessage.  # noqa: E501
        :rtype: CreateMessageMessage
        """
        return self._message

    @message.setter
    def message(self, message):
        """Sets the message of this CreateMessage.


        :param message: The message of this CreateMessage.  # noqa: E501
